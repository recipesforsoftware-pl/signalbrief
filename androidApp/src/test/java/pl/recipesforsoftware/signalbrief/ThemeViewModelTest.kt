...
class ThemeViewModelTest {
    ...
    private fun createViewModel(): ThemeViewModel = ThemeViewModel(themePreference)

    @Test
    fun `initial state is false when preference is false`() =
        runTest {
            // Given
    ...
    @Test
    fun `initial state reflects preference true after collection`() =
        runTest {
            // Given
    ...
    @Test
    fun `toggleDarkMode when off calls setDarkMode with true`() =
        runTest {
            // Given
            darkModeFlow.value = false
            viewModel = createViewModel()
    ...
    @Test
    fun `toggleDarkMode when on calls setDarkMode with false`() =
        runTest {
            // Given
            darkModeFlow.value = true
            viewModel = createViewModel()
    ...
    @Test
    fun `setDarkMode true calls preference with true`() =
        runTest {
            // Given
            viewModel = createViewModel()
    ...
    @Test
    fun `setDarkMode false calls preference with false`() =
        runTest {
            // Given
            viewModel = createViewModel()
    ...
    @Test
    fun `isDarkMode emits updated value when preference changes`() =
        runTest {
            // Given
            viewModel = createViewModel()
    ...
    @Test
    fun `toggleDarkMode multiple times calls preference each time`() =
        runTest {
            // Given
            darkModeFlow.value = false
            viewModel = createViewModel()
