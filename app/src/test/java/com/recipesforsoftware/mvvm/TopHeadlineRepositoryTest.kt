...
class TopHeadlineRepositoryTest {
    ...
    @Test
    fun `getTopHeadlines returns articles on success`() =
        runTest {
            // Given
    ...
    @Test
    fun `getTopHeadlines returns empty list when no articles`() =
        runTest {
            // Given
            val response =
                TopHeadlinesResponse(
    ...
    @Test
    fun `getTopHeadlines returns failure on network error`() =
        runTest {
            // Given
    ...
    @Test
    fun `getTopHeadlines returns failure on HTTP error`() =
        runTest {
            // Given
    ...
    @Test
    fun `getTopHeadlines maps articles correctly`() =
        runTest {
            // Given
            val article =
                Article(
