...
class TopHeadlineViewModelTest {
    ...
    @Test
    fun `fetchTopHeadlines failure updates state to Error`() =
        runTest {
            // Given
    ...
    @Test
    fun `fetchTopHeadlines failure with null message shows default error`() =
        runTest {
            // Given
    ...
    @Test
    fun `fetchTopHeadlines called with correct country`() =
        runTest {
            // Given
